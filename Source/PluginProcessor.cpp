...
#endif
{
    ...
    auto floatHeloper = [&apvts = this->apvts, &params](auto& param, const auto& paramName)
    {
        param = dynamic_cast<juce::AudioParameterFloat*>(apvts.getParameter(params.at(paramName)));
        jassert(param != nullptr);
    };

    floatHeloper(compressor.attack, Names::Attack_Low_Band);
    floatHeloper(compressor.release, Names::Release_Low_Band);
    floatHeloper(compressor.threshold, Names::Threshold_Low_Band);
    floatHeloper(compressor.attack, Names::Attack_Low_Band);
    floatHeloper(compressor.attack, Names::Attack_Low_Band);
